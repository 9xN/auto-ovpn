...
const generateReadme = (vpnList) => {
    ...
    vpnList.servers.forEach((server, index) => {
        ...
        content += `| ${server.hostname} | ${server.ip} | ${server.ping} | ${speedInMbps} Mbps | ${server.countrylong} | [Download 📥](./configs/server_${index}_${server.countryshort}.ovpn) | ${server.score / 100000} |\n`;
    });
